	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    listview.setOnItemClickListener(new OnItemClickListener() {
	    	  public void onItemClick(AdapterView<?> parent, View view,
	    		...
	    		com.example.soundanalyser.SoundAnalyserActivity.recordLength=timeValue;
	    		 
	    		//get back to SoundAnalyserActivity
	    			com.example.soundanalyser.SoundAnalyserActivity.isRecordingStarted = true;
